...
%
%======================================================
% Company:  MIMO-OFDM Wireless Communications with MATLAB¢ç   Yong Soo Cho, Jaekwon Kim, Won Young Yang and Chung G. Kang
...
% Modulation order or Alphabet (Symbol) size
M=2^b; 
if b==1 
    Mod='BPSK'; 
    A=1; 
